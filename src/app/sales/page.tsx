...
import { CopySlashIcon as Cash, Save, Loader2 } from "lucide-react";
  ...
  return (
    <div className="p-8 max-w-7xl mx-auto w-full">
      ...
      <div className="grid grid-cols-1 xl:grid-cols-3 gap-8">
        <div className="glass p-6 rounded-2xl border-t-2 border-emerald-500/50 h-fit xl:col-span-1">
        ...
        <div className="xl:col-span-2 glass p-6 rounded-2xl border-t-2 border-slate-700/50 overflow-hidden flex flex-col">

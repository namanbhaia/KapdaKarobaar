...
import { UserPlus, Save, Loader2, IndianRupee } from "lucide-react";
    ...
    <div className="p-8 max-w-6xl mx-auto w-full">
      <div className="flex justify-between items-center mb-8">
        <div>
          ...
          <p className="text-slate-400 mt-2">Register new suppliers and view your vendor directory</p>
        </div>
      </div>

      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        <div className="glass p-6 rounded-2xl border-t-2 border-indigo-500/50 h-fit">
        ...
        <div className="lg:col-span-2 glass p-6 rounded-2xl border-t-2 border-slate-700/50">
